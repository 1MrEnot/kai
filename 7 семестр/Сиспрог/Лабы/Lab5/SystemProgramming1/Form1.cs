...
namespace SystemProgramming1
{
    public partial class Form1 : Form
    {
        ...
        void Clear_tables()
        {
            ...
            dataGridViewTune_table.Rows.Clear();
        ...
        bool Start(int param)
        {
            ...
            switch (param)
            {
                ...
                //            SelectRow(i);
                //            //Если нашли ошибку 
                //            if (!support.Pass(dataGrid_symbol_table, dataGrid_supportTable, i, dataGridViewTune_table))
                //            {
                //                Add_error(textBox_first_errors, support.error_message);
                //                return false;
                //            }
                ...
                case 2:
                    {
                        ...
                        if (current_row + 1 <= dataGrid_Source.RowCount)
                        {
                            ...
                            if (!support.Pass(dataGrid_symbol_table, dataGrid_supportTable, current_row, dataGridViewTune_table))
                            {
                                Add_error(textBox_first_errors, support.error_message);
                                Clear_tables();
                                return false;
                        ...
                        else
                        {
                            if (support.EndFlag == 0)
                            {
                                Add_error(textBox_first_errors, "Исходный текст программы --> Строка {" + (current_row + 1) + "} Ошибка: Не найдена директива END");
                                Clear_tables();
                                return false;
                            }
                ...
                case 4:
                    {
                        ...
                        for (int r = current_row; r <= dataGrid_Source.RowCount; r++)
                        {
                            if (r + 1 <= dataGrid_Source.RowCount)
                            {
                                ...
                                if (!support.Pass(dataGrid_symbol_table, dataGrid_supportTable, r, dataGridViewTune_table))
                                {
                                    Add_error(textBox_first_errors, support.error_message);
                                    Clear_tables();
                                    return false;
                            ...
                            {
                                //Add_error(textBox_first_errors, "EndF = " + support.EndFlag);
                                if (support.EndFlag == 0)
                                {
                                    Add_error(textBox_first_errors, "Исходный текст программы --> Строка {" + (r + 1) + "} Ошибка: Не найдена директива END");
                                    Clear_tables();
                                    return false;
                                }
                                /*
        ...
        private void toolStripExamples_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (toolStripExamples.SelectedIndex > -1)
            {
                ...
                if (toolStripExamples.SelectedIndex == 0)
                {
                    ...
                    dataGrid_Source.Rows.Add("PROG", "START", "0", "");
                    ...
                    dataGrid_Source.Rows.Add("", "END", "10", "");
                ...
                if (toolStripExamples.SelectedIndex == 1)
                {
                    ...
                    dataGrid_Source.Rows.Add("PROG", "START", "0", "");
                    dataGrid_Source.Rows.Add("D4", "RESB", "10", "");
                    dataGrid_Source.Rows.Add("D23", "RESB", "10", "");
                    dataGrid_Source.Rows.Add("T1", "JMP", "[D2]", "");
                    dataGrid_Source.Rows.Add("", "SAVER1", "[D546]", "");
                    dataGrid_Source.Rows.Add("D42", "LOADR2", "[T1]", "");
                    dataGrid_Source.Rows.Add("", "RESB", "10", "");
                    dataGrid_Source.Rows.Add("", "", "", "");
                    dataGrid_Source.Rows.Add("D2", "SAVER1", "[D2]", "");
                    dataGrid_Source.Rows.Add("D546", "LOADR1", "[D2]", "");
                    dataGrid_Source.Rows.Add("T3", "INT", "200", "");
                    dataGrid_Source.Rows.Add("", "END", "0", "");
                ...
                if (toolStripExamples.SelectedIndex == 3)
                {
                    dataGrid_Source.Rows.Clear();
                    dataGrid_Source.Rows.Add("PROG", "START", "0", "");
                    dataGrid_Source.Rows.Add("D0", "RESB", "10", "");
                    dataGrid_Source.Rows.Add("D32", "RESB", "10", "");
                    dataGrid_Source.Rows.Add("T1", "JMP", "[D2]", "");
                    dataGrid_Source.Rows.Add("", "SAVER1", "D546", "");
                    dataGrid_Source.Rows.Add("D42", "LOADR2", "[T1]", "");
                    dataGrid_Source.Rows.Add("", "RESB", "10", "");
                    ...
                    dataGrid_Source.Rows.Add("D2", "SAVER1", "[D2]", "");
                    dataGrid_Source.Rows.Add("D546", "LOADR1", "D2", "");
                    dataGrid_Source.Rows.Add("T6", "INT", "200", "");
                    dataGrid_Source.Rows.Add("D4", "RESB", "10", "");
                    dataGrid_Source.Rows.Add("D23", "RESB", "10", "");
                    dataGrid_Source.Rows.Add("T4", "JMP", "[D2]", "");
                    dataGrid_Source.Rows.Add("", "SAVER1", "D546", "");
                    dataGrid_Source.Rows.Add("D4652", "LOADR2", "[T1]", "");
                    dataGrid_Source.Rows.Add("", "RESB", "10", "");
                    dataGrid_Source.Rows.Add("", "", "", "");
                    dataGrid_Source.Rows.Add("D72", "SAVER1", "[D2]", "");
                    dataGrid_Source.Rows.Add("D46", "LOADR1", "D2", "");
                    dataGrid_Source.Rows.Add("T7", "INT", "200", "");
                    dataGrid_Source.Rows.Add("", "END", "0", "");


                    //dataGrid_Source.Rows.Clear();
                    //dataGrid_Source.Rows.Add("PROG", "START", "0", "");
                    //dataGrid_Source.Rows.Add("", "EXTDEF", "D23", "");
                    //dataGrid_Source.Rows.Add("", "EXTDEF", "D4", "");
                    //dataGrid_Source.Rows.Add("", "EXTREF", "D2", "");
                    //dataGrid_Source.Rows.Add("", "EXTREF", "D546", "");
                    //dataGrid_Source.Rows.Add("D4", "RESB", "10", "");
                    //dataGrid_Source.Rows.Add("D23", "RESB", "10", "");
                    //dataGrid_Source.Rows.Add("T1", "JMP", "D2", "");
                    //dataGrid_Source.Rows.Add("", "SAVER1", "D546", "");
                    ...
                    //dataGrid_Source.Rows.Add("", "RESB", "10", "");
                    //dataGrid_Source.Rows.Add("", "", "", "");
                    //dataGrid_Source.Rows.Add("A2", "CSECT", "", "");
                    //dataGrid_Source.Rows.Add("", "EXTDEF", "D2", "");
                    //dataGrid_Source.Rows.Add("", "EXTREF", "D4", "");
                    ...
                    //dataGrid_Source.Rows.Add("", "LOADR2", "B4", "");
                    //dataGrid_Source.Rows.Add("", "LOADR1", "[D2]", "");
                    //dataGrid_Source.Rows.Add("T3", "INT", "200", "");
                    //dataGrid_Source.Rows.Add("", "END", "0", "");
